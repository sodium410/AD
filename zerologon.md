Don't try, check before running the attack could break domain controller  
...
resets domain auth to null, this setting to be restored otherwise breaks the envi..  
